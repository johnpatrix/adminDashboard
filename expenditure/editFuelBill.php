	...
	<body>
		...
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="pdfGenerate.php">Preview</a></li>
					...
					Bill Type Name: 
						<select id="bill_Type_name" name="billType_name" class="custom-select custom-select-sm mb-3">
							<?php  
								...
								foreach ($data as $key) {
									if($key['Bill_id'] == $_SESSION['bill_type_id'])
										echo "<option selected value='".$key['Bill_id']."' >".$key['Bill_Type_Name']."</option>";
									else
