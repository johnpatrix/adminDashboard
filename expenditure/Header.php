  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="newbill.php">New Office Expense Bill</a>
          <a class="dropdown-item" href="edithomepage.php">Edit Office Expense Bill</a>
          <a class="dropdown-item" href="deleteFuelBill.php">Delete Office Expense Bill</a>
            <div class="dropdown-divider"></div>             
             
          <a class="dropdown-item" href="newBillType.php">New Bill Type</a>
          <a class="dropdown-item" href="deleteBillType.php">Delete Bill Type Bill</a>
        </div>
